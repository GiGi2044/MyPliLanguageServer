...
/* A CHARACTER constant is a contiguous sequence of characters enclosed
...
mode EXEC_MODE;
SQL                     : S Q L -> mode(SQL_MODE)
                        ;
CICS                    : C I C S -> mode(CICS_MODE)
                        ;
...
mode SQL_MODE;
SEMICOLON_SQL           :   SEMICOLON -> skip,mode( DEFAULT_MODE )
                        ;
SQL_BODY                :   ~( ';' )*
                        ;

mode CICS_MODE;
CICS_SQL                :   SEMICOLON -> skip,mode( DEFAULT_MODE )
                        ;
CICS_BODY                :   ~( ';' )*
                        ;
