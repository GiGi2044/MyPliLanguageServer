...
public class PliLanguageServer implements LanguageServer, LanguageClientAware {
    private TextDocumentService textDocumentService;
    private WorkspaceService workspaceService;
    private LanguageClient client;
    private int errorCode = 1;

    public PliLanguageServer() {
        this.textDocumentService = new PliTextDocumentService();
        this.workspaceService = new PliWorkspaceService();
    }
